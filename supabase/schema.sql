...
create table if not exists public.entries (
  ...
  kind text not null check (kind in ('daily','infusion','bloods','med','question','flag','appointment','admission','inventory','signal','trend','dose','fuel','hydration','symptom','relief')),
