...
export const SIDE_EFFECTS: SideEffect[] = [
  ...
  },
  {
    ...
    whatToDo: [
      ...
      "Small sips of fluid often",
      "Bland foods like toast or dry biscuits",
      "Avoid greasy, rich, or strong-smelling food",
    ],
    urgent: ["Call the treating team the same day"],
    urgentAction: "call",
    escalation: "Move to Red if vomiting is persistent, severe, or they cannot keep fluids down",
  },
  {
    id: "diarrhoea",
    title: "Diarrhoea",
    ...
    whatToDo: [
      ...
      "Small frequent sips",
      "Simple low-fibre foods",
      "Anti-diarrhoea medication only if the team has advised it",
    ],
    urgent: ["Call the treating team the same day"],
    urgentAction: "call",
    escalation: "Move to Red if diarrhoea is severe, ongoing, or the person becomes dizzy, light-headed, or dehydrated",
  },
  {
  ...
  },
  {
    ...
    description: "Light-headed, wobbly, or feeling like you might black out — particularly when going from lying or sitting to standing. Common when fluids are low, after rituximab, or when blood pressure drops.",
    symptoms: [
