...
export const SIDE_EFFECTS: SideEffect[] = [
  ...
  },
  {
    ...
    whatToDo: [
      "Use the energy rule — if a short task can be done with recovery, pace it",
      "If showering, dressing, or walking room to room wipes them out, treat that as a symptom change rather than normal fatigue",
      "Split jobs into chunks and sit between them",
      "Don't save all movement for one push — crash and burn is useless",
      "If fatigue suddenly spikes, check for fever, dehydration, bleeding, breathlessness, or poor intake",
    ],
    urgent: [
      "Call the team if fatigue is suddenly worse",
      "Call the team if fatigue is paired with dizziness or clearly out of proportion to activity",
    ],
    urgentAction: "call",
    escalation: "Move to Red and go to ED if fatigue comes with chest pain, breathlessness, confusion, or collapse",
  },
  {
  ...
  },
  {
    ...
    whatToDo: [
      "If they say 'I feel off', 'I feel fluey', 'I'm shivery', or 'I think I'm hot' — check the temperature, don't guess",
      "Keep a thermometer in one obvious place",
      "Check morning and evening if unwell, plus any time they suddenly feel worse",
      "Look in the mouth once a day — ulcers, white coating, cold sores are early infection clues",
      "Inspect skin breaks, line sites, and wounds — don't assume you'd notice",
      "Note when symptoms started and whether they're getting worse",
      "Avoid contact with sick people, good hand hygiene",
    ],
    urgent: [
      "Call the team the same day for sore throat, new cough, mouth sores, white patches, burning urine, or a wound looking redder",
    ],
    urgentAction: "call",
    escalation: "Move to Red and go to ED now for 38°C or higher, shaking chills or rigors, shortness of breath, fast deterioration, or 'seriously unwell' even without a temperature",
  },
  {
    ...
    whatToDo: [
      "Track what's actually happening — new bruises without a clear cause, nosebleeds, bleeding gums, pinprick red/purple spots, blood in urine or stool",
      "Soft toothbrush only",
      "Avoid aspirin, ibuprofen, or other anti-inflammatories unless the team has specifically approved them",
      "Avoid bump-risk activities — falls, contact sports, anything jolting",
      "Use an electric shaver rather than blades if needed",
      "If a bleed starts, apply firm pressure and time how long it takes to stop — don't guess afterwards",
    ],
    urgent: [
      "Call the team for new bruising, new bleeding, or petechiae",
      "Call the team if a bleed takes longer than usual to stop",
    ],
    urgentAction: "call",
    escalation: "Move to Red and go to ED for heavy bleeding, bleeding that won't stop, black stools, or any faintness with bleeding",
  },
  {
    id: "rash-mild",
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    whatToDo: [
      "Don't leave it sitting for days because it looks small — when immunity is low, cold sores are an early infection clue",
      "Look at the lips and mouth in good light",
      "Keep the area clean — do not pick at sores",
      "Do not share drinks, utensils, lip products, or towels",
      "Keep lips moisturised if cracking",
      "Note when it started and whether it's spreading or worsening",
    ],
    urgent: [
      "Call the team for new cold sores or any cold sore in someone immunosuppressed — antiviral may be needed early",
    ],
    urgentAction: "call",
    escalation: "Move to Red and go to urgent care or ED for fever with the cold sore, rapidly worsening pain, sores spreading beyond the lip, or unable to drink or swallow",
  },
  {
    ...
    whatToDo: [
      "Don't leave ulcers or white patches sitting for days — they can be early infection clues in someone immunosuppressed",
      "Look in the mouth in good light once a day",
      "Soft toothbrush, gentle mouth care",
      "Switch to cooler, softer foods if the mouth is sore",
      "Avoid acidic, salty, or spicy foods if they sting",
      "Keep lips moisturised if cracking",
      "Don't wait for the next routine review if swallowing is getting harder",
    ],
    urgent: [
      "Call the team for new ulcers, white patches, or coating that wasn't there yesterday",
      "Call the team if pain is making it hard to eat or drink",
    ],
    urgentAction: "call",
    escalation: "Move to Red and go to urgent care or ED if they cannot drink, cannot swallow properly, or are becoming weak from poor intake",
  },
  {
